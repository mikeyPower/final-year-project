...
This project has introduced both ZMap a high speed port scanner and ZGrab an application banner grabber within Trinity College Dublin and also showed how these applications can be used to effectively answers questions regarding the current state of web servers such as to what was presented here in Chapter 1.\\
...
Would be interesting to rate the successfulness of ZMap by the determining the actual number of know hosts on port 80 and port 443\\
