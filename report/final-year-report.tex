...
In terms of the actual banner grab there are a number of aspects of a web server that we are interested in when we conduct are ZGrab application layer scans in order to see the contrast and similarities the underlying information of the web Servers are to each other scans they are as follows:
...
\begin{itemize}
  ...
  \item Certificate start and end date.
