...
\begin{figure}[H]
  \centering
  \subfloat[Page Redirect]{\includegraphics[width=0.4\textwidth]{images/redirect}\label{fig:f1}}
  \hfill
  \subfloat[Polycom]{\includegraphics[width=0.4\textwidth]{images/polycom}\label{fig:f2}}
  \hfill
 % \caption{My flowers.}
  \subfloat[Lexmark X363dn]{\includegraphics[width=0.4\textwidth]{images/printer}\label{fig:f1}}
  \hfill
  \subfloat[Web Image Monitor]{\includegraphics[width=0.4\textwidth]{images/image_monitor}\label{fig:f2}}
...
\begin{table}[H]
\centering
\subfloat[How an IP thats open on both port 80 and 443 handles connections to port 80]{
\scalebox{0.5}{
%
\begin{tabular}{|| c c ||}
 \hline
...
\hfill
\subfloat[How an IP thats open on both port 80 and 443 handles connections to port 443]{
\scalebox{0.5}{%
\begin{tabular}{|| c c ||}
 \hline
  Status Code and Response Phrase & Number of IP addresses  \\ [0.5ex]
...
\caption{IP status codes on Both Ports}

\label{table:status_code_both_port_443}
\end{table}

\begin{table}[H]
\centering
%\resizebox{\columnwidth}{!}{%
\subfloat[Status codes of IPs on a Port 80 (only) making connections to port 80]{
\scalebox{0.5}{
\begin{tabular}{|| c c ||}
 \hline
  Status Code and Response Phrase & Number of IP addresses  \\ [0.5ex]
...
%}
\hfill
\subfloat[Status codes of IPs on a Port 443 (only) making connections to port 443]{
\scalebox{0.6}{%
\begin{tabular}{|| c c ||}
 \hline
  Status Code and Response Phrase & Number of IP addresses  \\ [0.5ex]
...
\caption{IP status codes on port 80 (only) and port 443 (only)}
\label{table:status_code_both_port_80}
\end{table}
The tables \ref{table:status_code_both_port_443} and \ref{table:status_code_both_port_80} above highlight the response code and phrase returned from each IP connection throughout the ZGrab scans.
